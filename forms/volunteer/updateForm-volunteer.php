...
<main>
    <form action="_updateVolunteer.php?id=<?= isset($_GET['id'])? (int) $_GET['id'] : 0?>" method="POST"  enctype="multipart/form-data">
        ...
        <div class="input-container">
            <div class="fgrow-2">
                <p> Contact Number </p> 
                <input type = "text" name="contactnum" value="<?php echo isset($volunteer["contactNumber"]) ? $volunteer["contactNumber"] : ''; ?>">
            </div>
            <div class="fgrow-2">
                <p> Nationality </p> 
        ...
        <div class="input-container">
            ...
            <div class="fgrow-1">
                ...
                <input type="hidden" name="profile_default" value="<?php echo isset($volunteer["profileImage_url"]) ? $volunteer["profileImage_url"] : ''; ?>">
            </div>
        </div>
        ...
        <br/>
        <div class="input-container">
            <input type="submit" class="bttn-primary fgrow-1" value="Edit Volunteer">
